    ...
    function getOutputValue(){
      ...
      if(tape != ""){
        $.ajax({
          url: "compileFile.php",
          type: "post",
          data: {text: textFromFile,fileName: getFileName(),tape : tape, area : getArea() , login: getLogin()},
          // callback handler that will be called on success
          success: function(response, textStatus, jqXHR){
              // log a message to the console
              console.log(response);
        ...
        alert("You must to put something in the tape!");
      }
...
$(document).ready(function() {
  ...
  /*Iniciando com alguma coisa na fita*/
  $("#tape textarea").val("aaaaa");
