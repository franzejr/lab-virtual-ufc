...
<!-- Botoes em baixo da listagem dos arquivos -->
<input type="button"
       class="button"
       title="Show help"
       id="help"
...
<div id="visible_files_container"
  ...
  Tape:  <input id="tape" class="tape_input" name="tape" type="text" />
    ...
    function getOutputValue(){
      ...
      if(tape != ""){
        $.ajax({
          ...
          type: "post",
          data: {"text": textFromFile,"tape":tape,"fileName":fileName},
...
$(document).ready(function() {
  ...
  $('#help').click(function() {
    cd.dialog("This system is a simulation of a turing Diagram. You must to put something in the Tape File and then you can use some code that already exist or you can create yourself a code, and later you can execute your code into a turing machine.",400,"Help");
  });
